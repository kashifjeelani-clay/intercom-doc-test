...
## Troubleshooting referral credits

If expected referral credits haven't appeared yet:

- **Check the paid plan requirement.** Credits are only awarded after the referred person subscribes to a paid Clay plan. If they signed up but haven't upgraded, credits won't be issued yet.
- **Allow time for processing.** Credits are typically applied around 30 days after the referred user upgrades — they won't appear immediately.
- **Verify the referral link was used during sign-up.** The referral link must be used at the point of registration. If the referred person signed up without the link, Clay cannot retroactively grant referral credits.
- **Contact Clay Support** if the referral link was used correctly, the referred user has subscribed to a paid plan, and credits still haven't been applied after 30 days.
